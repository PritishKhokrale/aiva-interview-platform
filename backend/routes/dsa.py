    ...
    for i, case in enumerate(test_cases):
        ...
        try:
            ...
            if output == case["expected"]:
                passed += 1
                results.append({"testcase": i + 1, "status": "Passed"})
            else:
                results.append({"testcase": i + 1, "status": "Failed"})
        except Exception:
            results.append({"testcase": i + 1, "status": "Failed - Execution Error"})
